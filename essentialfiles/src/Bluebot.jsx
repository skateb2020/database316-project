      ...
      <div className="hero">
        <div className="hero-inner">
          <div style={{ display: 'flex', gap: 8, marginBottom: 24 }}>
            {[['/', '← Home'], ['/search', 'Course Search 🔍'], ['/compare', 'Compare Courses ⚖️'], ['/scheduler', 'Smart Scheduler 🗓️'], ['/optimizer', 'Optimizer 🔀'], ['/programs', 'Programs 🎓'], ['/profile', 'My Profile 👤'], ['/professors', 'Prof Ratings ⭐']].map(([path, label]) => (
